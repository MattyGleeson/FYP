...
{
    public class RoomTypeAdminController : MessageControllerBase
    {
        ...
        {
            return View(db.RoomTypes.Where(v => !v.deleted).ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "id,name,deleted")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,deleted")] RoomType roomType)
        {
            if (ModelState.IsValid)
            {
